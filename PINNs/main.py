...
def main(args):
    ...
    observe_x, V, W, Vsav, all_t = dynamics.generate_data(v_file_name, w_file_name, pt_file_name)  #Temporary becasue we dont have W yet!! Plz add w_file_name later
    print(Vsav.shape)
    ...
    plot_results(Vsav, observe_train, v_train, observe_test, v_pred, all_t, args.model_folder_name, args.animation)
